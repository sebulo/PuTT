...
def run_train(config_file):
    ...
    for seed, init_reso, max_rank, tilting_mode, tilt_angle, noise_type, noise_std, iterations_for_upsampling, batch_size, lr, num_iterations, subset_to_train_on in parameter_combinations:
